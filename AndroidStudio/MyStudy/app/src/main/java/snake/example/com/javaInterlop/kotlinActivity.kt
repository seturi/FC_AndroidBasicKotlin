...
// java 로 만든 클래스에서도 확장함수 추가가 가능하다!!
fun javaActivity.kotlinEventHandler(){

    // javaActivity 에서 선언한 멤버필드
    val s  = sMessage

    // javaActivity 에서 정의한 Control
    btnOk.setOnClickListener {

        // javaActivity 의  T 메소드 사용
...
class KotlinExport{
    ...
    // java 에서는 메소드처럼 사용됨
    // @JvmField var normal_variable 로 하면 java 에서도 멤버변수처럼 사용가능
